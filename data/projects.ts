...
export const projects: Project[] = [
  ...
  },
  {
    id: 4,
    slug: "betar-quesheet",
    title: "Betar Quesheet",
    category: "fullstack",
    type: "Full Stack Application",
    shortDescription:
      "Quesheet management system for Betar Barishal — organize, track, and print program cue sheets.",
    description:
      "A comprehensive quesheet management platform built for Betar Barishal. Users can create, edit, organize, and print program cue sheets with ease. The app supports drag-and-drop reordering of cue items, Bangla calendar integration for scheduling, real-time editing via contenteditable fields, and print-ready export. Firebase handles authentication and data persistence, making the system fast and reliable for daily broadcast operations.",
    image: "/images/projects/equesheet.png",
    tech: [
      "React",
      "TypeScript",
      "Vite",
    ...
    features: [
      "Create, edit, and delete quesheet entries",
      "Drag-and-drop reordering of cue items",
      "Bangla calendar integration for Bangladeshi date support",
      "Inline contenteditable fields for fast editing",
      "Print-ready quesheet export via react-to-print",
      "Firebase authentication and real-time database",
      "Responsive UI with Tailwind CSS",
      "Smooth animations with Framer Motion",
      "Form validation with React Hook Form",
      "Lottie animations for loading and empty states",
      "Alert and confirmation dialogs via SweetAlert2",
      "Offline-capable storage with localforage",
    ],
